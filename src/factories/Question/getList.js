...
module.exports = async ({code, content, answer, status, quiz_id, end_date, start_date}, {page, limit}) => {
    const {page: _page, skip: _skip, limit: _limit} = _parsePaging({page, limit})
    const query = _buildQuery({code, content, answer, status, quiz_id, end_date, start_date})
